...
import 'package:nutricare_connect/features/appointments/client_booking_sheet.dart';
              ...
              sliver: SliverGrid.count(
                ...
                children: [
                  ...
                  _buildCompactActionCard(
                    ...
                    // 🎯 USE THE NEW SHEET
                        () {
                      // We need the dietitian profile. It's in the AsyncValue above.
                      final profile = dietitianAsync.value;
                      if (profile != null) {
                        showModalBottomSheet(
                            context: context,
                            isScrollControlled: true,
                            backgroundColor: Colors.transparent,
                            builder: (_) => ClientBookingSheet(client: client, coach: profile)
                        );
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Coach profile loading...")));
                      }
                    },
                  ),
                  _buildCompactActionCard(
