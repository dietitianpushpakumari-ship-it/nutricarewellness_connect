...
import 'package:nutricare_connect/features/dashboard/modern_bottom_bar.dart';
...
import 'package:nutricare_connect/features/dashboard/home_screen.dart';
...
import '../auth/client_service.dart';
import '../dietplan/domain/entities/client_diet_plan_model.dart';
import '../dietplan/domain/entities/client_log_model.dart';
import '../dietplan/PRESENTATION/providers/diet_plan_provider.dart';
...
class ClientDashboardScreenState extends ConsumerState<ClientDashboardScreen> {
  ...
  String _getPageTitle(int index) {
    switch (index) {
      ...
      case 4: return context.tr("My Coach");
      default: return "";
    }
  }
